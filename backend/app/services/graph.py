...
class GraphService:
    ...
    def query_vector(self, vector: list[float], top_k: int = 5, min_score: float = 0.7) -> list[dict]:
        """
        ...
        """
        return self.execute_query(query, {"vector": vector, "top_k": top_k, "min_score": min_score})
