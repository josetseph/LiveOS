...
function makeLinkComponent(onFileClick: (url: string, filename: string) => void) {
...
export function SegmentedNoteContent({
    ...
    const segments = parseSegments(content || "*Empty note*");
    const LinkComponent = makeLinkComponent(onFileClick);
